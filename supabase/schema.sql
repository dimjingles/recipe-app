...
create table if not exists profiles (
  ...
  chef_pacing text not null default 'step_by_step' check (chef_pacing in ('step_by_step', 'hands_free', 'overview_first')),
  chef_voice_uri text,
...
-- ============================================================
-- FEATURE 09 · SOCIAL (friends, shared collections, activity feed)
