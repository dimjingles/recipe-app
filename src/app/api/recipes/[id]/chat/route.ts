...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const system = [
    ...
    ``,
    `COACHING RULES:`,
    `- If the user asks for a welcome or overview, give a warm 2-3 sentence intro to the dish (what you're making and the general vibe) WITHOUT listing any steps, and end by asking if they are ready to begin.`,
